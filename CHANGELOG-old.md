...
## PluginBase 5.2.1
-------------------------------------------
* Updated the dependency to MoEngage-iOS-SDK `9.22.2`

## Cards 2.2.1
-------------------------------------------
* Updated the dependency to PluginBase `5.2.1`
...
## Cards 2.2.0
-------------------------------------------
* Updated the dependency to PluginBase `5.2.0`
...
* Updated the dependency to MoEngage-iOS-SDK `9.16.1`.

## Cards 1.4.0
-------------------------------------------
* Updated the dependency to MoEngageCards `4.15.1`.
...
## Cards 1.2.0
-------------------------------------------
* Updated the dependency to MoEngageCards `4.12.0`

## Inbox 2.5.0
-------------------------------------------
* Updated the dependency to MoEngageInbox `2.12.0`

## Geofence 2.5.0
-------------------------------------------
* Updated the dependency to MoEngageGeofece `5.12.0`.
